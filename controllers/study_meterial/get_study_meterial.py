...
def get_study_material():
    try:
        ...
        try:
            ...
            return api_response("Token has expired", 401, "error")
        except Exception:
        ...
        cursor.execute("CALL learning.sp_get_study_material(%s)", ("cur1",))
        ...
        return api_response(
            message="Files fetched successfully", data=data, code=200, status="success"
        )
