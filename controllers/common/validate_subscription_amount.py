...
def validate_subscription_amount():
    ...
    try:
        ...
        cur.execute("""
            CALL subscription.usp_v4_validate_subscription_bulk(
                %s::jsonb,
                %s,
                NULL,
                NULL,
        ...
        return api_response(
            ...
            data={
                "db_total": float(result.get("p_db_total") or 0),
                "db_discount": float(result.get("p_db_discount") or 0),
                "db_final": float(result.get("p_db_final") or 0)
            }
        )
